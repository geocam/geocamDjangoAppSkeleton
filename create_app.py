...
if __name__ == '__main__':
    ...
    parser.add_option("--site-app", dest="site_app", action="store_true", default=False, help="True if this is generating the primary app for a new site")
    ...
    if options.site_app:
        templ_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), 'skel', '$$$$PKG_NAME$$$$'))
